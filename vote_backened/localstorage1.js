...
// login page
 function fdata()
 {
	alert("you can only vote if you have valid id registered else you will be redirected to the register page");
	 return true;
 }
...
function check()
{
	alert("if pre-requiste(like...nickname and studentid) are correct then only the password will be updated");
	return true;
}
	// if(id==20021175)
	// {
